      ...
      <div className="section-head__part3">
        ...
        <br /> 
            ...
            <br />
                 ...
                 <button className = 'first-body5__btn' type="submit">login </button>
                 <p className="first-body5__btn-p">forget password?</p>
                     </form>
                     ...
                     Don't have an account? <span className="first-body5__span">
                         sign up
                     </span>
                     </p>
